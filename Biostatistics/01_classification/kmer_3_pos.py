...
filename ="/beegfs/home/zmz/homework/01_data/classification/pos.fa"#输入fasta文件
...
feature_vectors.to_csv("pos"+str(3)+"_"+'mer'+'.txt', index=False, header = False,encoding='gbk',float_format='%.4f',sep = " ")
